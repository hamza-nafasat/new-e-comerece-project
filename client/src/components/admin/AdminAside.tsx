    ...
    <>
      ...
      <aside style={phoneActive ? { ...phoneActiveCss, left: showModal ? 0 : "-20rem" } : {}}>
        ...
        <section>
          <h5>Charts</h5>
          <ul>
            <LiComponent url={"/admin/charts/bar"} text={"Bar"} Icon={FaChartBar} location={location} />
            <LiComponent url={"/admin/charts/pie"} text={"Pie"} Icon={FaChartPie} location={location} />
            <LiComponent url={"/admin/charts/line"} text={"Line"} Icon={FaChartLine} location={location} />
          </ul>
        </section>
        {/* APPS SECTION */}
        {/* ============ */}
