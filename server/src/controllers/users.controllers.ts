...
export const createUser = TryCatch(async (req: Request<{}, {}, NewUserReqTypes>, res: Response, next: NextFunction) => {
  ...
  if (isAlreadyExist) return next(new CustomError("Email Already Exist", 400));
